...
router.put('/onboarding', protect, hasRole(['Pharmacy', 'DeliveryPartner']), uploadDocs, updateOnboarding);

// @route   PUT /api/users/status
// @desc    Toggle the online/offline status for a Delivery Partner.
// @access  Private (DeliveryPartner)
router.put('/status', protect, hasRole(['DeliveryPartner']), updateDeliveryStatus);
