...
const updateOnboarding = async (req, res) => {
  ...
  try {
    if (user.role === 'Pharmacy') {
      const { shopName, start, end, offDays, latitude, longitude } = req.body;
...
module.exports = {
  getProfile,
  updateProfile,
  updateUserLocation,   // ✅ include new location update function
  updateOnboarding,     // ✅ merged version with coordinates
